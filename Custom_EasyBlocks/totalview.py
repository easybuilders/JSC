...
# Authors::   Michael Knobloch <m.knobloch@fz-juelich.de>
# License::   MIT/GPL
# $Id$
#
...
class EB_TotalView(PackedBinary):
    ...
    def install_step(self):
        ...
        if cpu_arch == X86_64:
            ...
            cmd = "./Install -agree -platform linux-arm64 -nosymlink -install totalview -directory %s" % self.installdir
        else:
            cmd = "./Install -agree -nosymlink -install totalview -directory %s" % self.installdir
        run_cmd(cmd)
