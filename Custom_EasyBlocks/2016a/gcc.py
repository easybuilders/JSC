...
class EB_GCC(ConfigureMake):
    ...
    def configure_step(self):
        ...
        ##self.configopts += " --enable-gold=default --enable-plugin "
        #self.configopts += " --enable-ld --with-plugin-ld=ld.gold"
        
        #self.configopts += " --enable-gold=default "
        #self.configopts += " --enable-ld "
        self.configopts += " --enable-plugin "
        self.configopts += " --with-plugin-ld=ld.gold"
