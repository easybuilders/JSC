...
##
"""
EasyBuild support for lpsmpi compiler toolchain (includes LLVM compilers and ParaStationMPI).
...
class Lpsmpi(LLVMCompilersToolchain, Psmpi):
    """Compiler toolchain with LLVM and ParaStationMPI."""
    NAME = 'lpsmpi'
